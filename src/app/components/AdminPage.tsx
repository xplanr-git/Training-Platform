          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-1 mb-1">
                    ...
                    <button 
                      onClick={() => setActivePopover(activePopover === 'courses' ? null : 'courses')}
                      className="hover:bg-gray-100 rounded-full p-0.5 transition-colors"
                    >
                      <Info className="size-4 text-gray-400 cursor-pointer" />
                    </button>
                  </div>
                  <p className="text-3xl font-bold text-gray-900">{totalCompanyCoursesEnrolled}</p>
                  <p className="text-xs text-gray-500 mt-1">Enrolled by companies</p>
                </div>
              ...
              {activePopover === 'courses' && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10">
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="font-semibold text-gray-900">Total Courses Enrolled</h4>
                    <button 
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    This metric shows the total number of course enrollments across all company subscribers on your platform. It represents the sum of all courses that companies have enrolled their employees in, providing insight into overall platform adoption and usage across your client base.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-green-600 relative">
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-1 mb-1">
                    ...
                    <button 
                      onClick={() => setActivePopover(activePopover === 'students' ? null : 'students')}
                      className="hover:bg-gray-100 rounded-full p-0.5 transition-colors"
                    >
                      <Info className="size-4 text-gray-400 cursor-pointer" />
                    </button>
                  </div>
                  <p className="text-3xl font-bold text-gray-900">{totalCompanyStudents}</p>
                </div>
              ...
              {activePopover === 'students' && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10">
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="font-semibold text-gray-900">Total Students</h4>
                    <button 
                      onClick={() => setActivePopover(null)}
                      className="text-gray-400 hover:text-gray-600"
                    >
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    This displays the total number of active students (users) across all company subscribers. Each company subscriber has their own user base, and this metric aggregates all of them to show your platform's total reach. This helps you understand your platform's scale and growth across all business clients.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-purple-600 relative">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{avgCompanyRating}</p>
              ...
              {activePopover === 'rating' && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10">
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="font-semibold text-gray-900">Average Course Rating</h4>
                    <button 
                      onClick={() => setActivePopover(null)}
                      className="text-gray-400 hover:text-gray-600"
                    >
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    This metric represents the average course satisfaction rating across all company subscribers. It's calculated by averaging the individual rating scores from each company, giving you a quick snapshot of overall content quality and learner satisfaction across your entire platform.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-orange-600 relative">
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-1 mb-1">
                    ...
                    <button 
                      onClick={() => setActivePopover(activePopover === 'completion' ? null : 'completion')}
                      className="hover:bg-gray-100 rounded-full p-0.5 transition-colors"
                    >
                      <Info className="size-4 text-gray-400 cursor-pointer" />
                    </button>
                  </div>
                  <p className="text-3xl font-bold text-gray-900">{avgCompanyCompletionRate}%</p>
                  <p className="text-xs text-gray-500 mt-1">Across all companies</p>
                </div>
              ...
              {activePopover === 'completion' && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10">
                  <div className="flex items-start justify-between mb-2">
                    <h4 className="font-semibold text-gray-900">Course Completion Rate</h4>
                    <button 
                      onClick={() => setActivePopover(null)}
                      className="text-gray-400 hover:text-gray-600"
                    >
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    This shows the average percentage of courses that students complete across all company subscribers. A higher completion rate indicates strong engagement and effective learning experiences. This metric helps you gauge how well your content resonates with learners and identify areas for improving course retention.
                  </p>
                </div>
              )}
            </div>

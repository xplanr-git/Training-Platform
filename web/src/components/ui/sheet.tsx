...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        // `.sb-scrim`: ink-tinted, not pure black — matching the dialog overlays.
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
            'data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-[82%] max-w-[320px] border-l',
          side === 'left' &&
            // `.sb-drawer`: min(82%, 320px).
            'data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-[82%] max-w-[320px] border-r',
          side === 'top' &&
